...
| カテゴリ分類記号 | ユーザーが赤ペンでレシートの品目横に手書きする記号（✔︎×△▲）。赤色で印刷記号と区別する |
...
**IMG-14** [制約] カテゴリ分類記号は赤ペン（赤色のボールペン）で書かれる。赤色の筆跡のみを手書き記号として認識し、黒い印刷記号は無視する
...
**IMG-03** [導出] 赤ペンの ✔︎（チェックマーク）がついた品目は「除外8」（8%税率の除外品）に分類する
...
**IMG-04** [導出] 赤ペンの ×（バツマーク）がついた品目は「除外10」（10%税率の除外品）に分類する
...
**IMG-05** [導出] 赤ペンの △（三角）がついた品目は「日用品」に分類する
...
**IMG-06** [導出] 赤ペンの ▲（塗りつぶし三角）がついた品目は「くりお」（犬関連）とし、レシート上の税率に応じて除外8 または除外10 に分類する
